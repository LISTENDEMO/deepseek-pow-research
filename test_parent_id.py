...
print('=' * 60)
print('测试 parent_message_id 上下文')
print('=' * 60)
        ...
        try:
            ...
            if isinstance(data.get('v'), dict):
                ...
                if 'message_id' in response_obj:
                    message_id1 = response_obj['message_id']
        except:
            pass

print(f'  响应: {content1}')
print(f'  message_id: {message_id1}')

# 设置 parent_message_id
api.set_parent_message_id(message_id1)
    ...
    if line and line.startswith('data: '):
        try:
            ...
            if isinstance(data.get('v'), dict):
                response_obj = data['v'].get('response', {})
                if 'message_id' in response_obj:
                    message_id2 = response_obj['message_id']
        except:
            pass

print(f'  响应: {content2}')
print(f'  message_id: {message_id2}')
...
if '张三' in content2:
    ...
    print('✗ 无上下文 - AI 不知道名字')
    print(f'  parent_message_id 使用: {api.parent_message_id}')